### Generated logs from GitHub Action: [8684155916](https://github.com/coleenquadros/multicluster-observability-operator/actions/runs/8684155916)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240413112438-e446c102eaae
...
- go: downloading google.golang.org/genproto/googleapis/rpc v0.0.0-20240412170617-26222e5d3d56
- go: downloading google.golang.org/genproto v0.0.0-20240412170617-26222e5d3d56
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240413112438-e446c102eaae), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240413112438-e446c102eaae), but does not contain package github.com/openshift/hypershift/api/v1beta1
