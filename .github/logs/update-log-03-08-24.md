### Generated logs from GitHub Action: [8199399653](https://github.com/coleenquadros/multicluster-observability-operator/actions/runs/8199399653)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240308035756-23c5a3e2c9cc
...
- go: downloading github.com/aws/aws-sdk-go v1.50.34
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240308035756-23c5a3e2c9cc), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240308035756-23c5a3e2c9cc), but does not contain package github.com/openshift/hypershift/api/v1beta1
