### Generated logs from GitHub Action: [7969118009](https://github.com/coleenquadros/multicluster-observability-operator/actions/runs/7969118009)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240219190100-20d4d9a49d84
...
- go: downloading github.com/aws/aws-sdk-go v1.50.21
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240219190100-20d4d9a49d84), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240219190100-20d4d9a49d84), but does not contain package github.com/openshift/hypershift/api/v1beta1
