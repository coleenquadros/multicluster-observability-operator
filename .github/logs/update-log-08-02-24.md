### Generated logs from GitHub Action: [10210768235](https://github.com/coleenquadros/multicluster-observability-operator/actions/runs/10210768235)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240802050036-555fcef55725
...
- go: github.com/openshift/hypershift/api@v0.0.0-20240802050036-555fcef55725 requires go >= 1.22.0; switching to go1.22.5
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240802050036-555fcef55725), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240802050036-555fcef55725), but does not contain package github.com/openshift/hypershift/api/v1beta1
