### Generated logs from GitHub Action: [10192882994](https://github.com/coleenquadros/multicluster-observability-operator/actions/runs/10192882994)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240731215004-26b345609fda
...
- go: github.com/openshift/hypershift/api@v0.0.0-20240731215004-26b345609fda requires go >= 1.22.0; switching to go1.22.5
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240731215004-26b345609fda), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240731215004-26b345609fda), but does not contain package github.com/openshift/hypershift/api/v1beta1
